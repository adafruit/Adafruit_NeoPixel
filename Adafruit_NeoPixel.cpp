...
#if defined(NRF52)
#define NRF52_NEOPIXEL_USEDMA // Use the EasyDMA
//#define NRF52_DISABLE_INT // Remember to disable USEDMA if using this
#include "nrf.h"
#endif
...
// to work we need to store a 16 bit configuration for each register.
...
#pragma message("Compiling with DMA support") // Here just to inform
...
// Important: This was an experimental implementation and is know to
// lose frames when the Bluetooth SoftDevice is enabled.
...
#pragma message("Compiling without DMA support") // Just to inform
...
#endif // End of support of no DMA for the NRF52
